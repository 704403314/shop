...
<html xmlns="http://www.w3.org/1999/xhtml">
    ...
    <h1>
        <span class="action-span"><a href="<?php echo U('add',['nocache'=>NOW_TIME]);?>">添加文章</a></span>
        ...
        <div class="list-div" id="listDiv">
            <table cellpadding="3" cellspacing="1">
               ...
               <?php if(is_array($rows)): foreach($rows as $key=>$row): ?><tr>
                    ...
                    <td align="center">
                        <?php if(is_array($category_names)): foreach($category_names as $key=>$category): if($row["article_category_id"] == $category['id']): echo ($category['name']); endif; endforeach; endif; ?>
                    </td>
